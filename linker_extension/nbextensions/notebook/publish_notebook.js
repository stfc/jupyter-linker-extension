define(["base/js/namespace",
     ...
     *  upload_data
     */ 
    var publish_notebook_and_bundle_alternate = function() {
        var add_metadata_form_fields = add_metadata.create_fields();
        add_metadata_form_fields.form1.addClass("hide-me");
        add_metadata_form_fields.form2.addClass("hide-me");
                ...
                Next: { 
                    ...
                    click: function() {
                        if(!$("#files-page").hasClass("hide-me")) {
                            ...
                            upload_data.validate_metadata();
                            if($(".data-form-error").length === 0) {
                                var data_promise = upload_data.get_values_from_fields_alternate();
                                data_promise.then(function(results) { //success function
                                    data_metadata = results;
                            ...
                            request.then(function() {
                                ...
                                upload_data.upload_data_alternate(data_metadata);
                                upload_notebook.upload_notebook(metadata);
        ...
        modal.on("shown.bs.modal", function () {
            ...
            $("#data-files").MultiFile({
                ...
                STRING: {
                    remove: "<i class=\"fa fa-times\" aria-hidden=\"true\" title=\"Remove this file\"></i>",
                },
                afterFileAppend: function(element, value) {
                    //add accessibility label
                    $("#data-files-list").find(".MultiFile-remove").attr("aria-label","Remove this file");
     ...
     *  Only publish the data
     */ 
    var publish_bundle_alternate = function() {
    ...
    var publish_bundle_alternate_action = {
    ...
    var publish_bundle_alternate_action_name = "publish-bundle-alternate";
    ...
    var publish_both_alternate_action = {
        help: "Publish notebook and data bundle (alternate)",
        help_index: "a",
        icon: "fa-upload",
        handler : publish_notebook_and_bundle_alternate,
    };

    var publish_both_alternate_prefix = "linker_extension";
    var publish_both_alternate_action_name = "publish-notebook-and-data-bundle";
    ...
    var load = function () {
        ...
        Jupyter.actions.register(
            ...
            publish_bundle_alternate_action_name,
