define([
    ...
    var get_values_from_fields_alternate_2 = function() {
    ...
    var upload_data_alternate_2 = function(data) {
        var md = Jupyter.notebook.metadata;
        if ("databundle_url" in md) {
            //already uploaded to dspace so... TODO: do we want to block them if it"s already been uplaoded? should I grey out the button?
            custom_utils.create_alert("alert-warning",
            ...
            custom_contents.upload_data_alternate2(JSON.stringify(data)).then(
                function(response) {
                    var id = "";
                    var xml_str = response.split("\n");
                    xml_str.forEach(function(item) {
    ...
    var validate_files_alternate = function() {
        $(".data-form-error").remove();
    ...
    var upload_data_form_alternate_2 = function() {
        var files_page = $("<fieldset/>").attr("id","files-page");
        var metadata_page = $("<fieldset/>").addClass("hide-me").attr("id","metadata-page");
    ...
    module.exports = {
        ...
        upload_data_alternate_2: upload_data_alternate_2,
        upload_data_form_alternate_2: upload_data_form_alternate_2,
        get_values_from_fields_alternate_2: get_values_from_fields_alternate_2,
        validate_metadata: validate_metadata,
        validate_files: validate_files,
        validate_files_alternate: validate_files_alternate,
