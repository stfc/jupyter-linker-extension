casper.notebook_test(function() {
    ...
    casper.test.info("Testing selecting report metadata - data in subfolder");
    ...
    this.waitForSelector("a[href=\"/a@b/tree/sub%20%E2%88%82ir1\"] > span");
    this.thenClick("a[href=\"/a@b/tree/sub%20%E2%88%82ir1\"] > span");
    ...
    this.then(function tick_then() {
        var array = this.evaluate(function tick_eval() {
            var filename = encodeURIComponent("file_in_sub_∂ir1.txt");
            var dirname = encodeURIComponent("sub ∂ir 1a");
            var arr = [];
