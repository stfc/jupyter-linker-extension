...
casper.notebook_test(function() {
    ...
    var nbname = "test_redownload_data_rename.ipynb";
    ...
    this.thenEvaluate(function (nbname) {
        require(["base/js/events"], function (events) {
            ...
            md.reportmetadata = {
                "abstract": "A test item generated by redownload_data_rename.js" + 
    ...
    this.thenEvaluate(function() {
        ...
        contents.delete("/file_in_nbdir.txt").then(function() {
    ...
    this.then(function() {
        ...
        this.test.assert(deleted_item_not_found,"file_in_nbdir.txt successfully deleted");
    });
    ...
    this.thenClick("#filename-collision-behaviour-rename");
    ...
    this.thenEvaluate(function() {
        ...
        contents.list_contents("/").then(function(response) {
            $(document.body).append($("<div/>")
                                    .attr("id","directory-contents-after-download")
                                    .attr("items",JSON.stringify(response.content)));
        });
    ...
    this.waitForSelector("#directory-contents-after-download");
    this.then(function() {
        var directory_contents_str = this.getElementAttribute("#directory-contents-after-download","items");
        var directory_contents = JSON.parse(directory_contents_str);
        ...
        this.test.assert(deleted_item_found,"file_in_nbdir.txt successfully downloaded");
    });
    ...
    this.then(function() {
        ...
        directory_contents.forEach(function(item) {
            if(item["name"] === "file_in_sub_∂ir1(1).txt") {
                item_found = true;
            }

        });
        this.test.assert(item_found,"file_in_sub_∂ir1.txt successfully downloaded as file_in_sub_∂ir1(1).txt");
    });
    ...
    this.then(function() {
        ...
        var item_found = false;
        directory_contents.forEach(function(item) {
            if(item["name"] === "file_in_sub_∂ir1a(1).txt") {
                item_found = true;
            }

        });
        this.test.assert(item_found,"file_in_sub_∂ir1a.txt successfully downloaded as file_in_sub_∂ir1a(1).txt");
    });
