...
class UploadBundleHandler(IPythonHandler):
    ...
    def post(self):
        ...
        reference_xml = ET.SubElement(metadata,"epdcx:statement")
        reference_xml.set("epdcx:propertyURI","http://purl.org/dc/elements/1.1/type")
        value = ET.SubElement(reference_xml,"epdcx:valueString")
        value.text = "Dataset"
